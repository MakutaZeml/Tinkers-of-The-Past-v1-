...
public class JojoBlocks {
    ...
    public static final MetalItemObject meteoric = BLOCKS.registerMetal("meteoric", metalBuilder(MaterialColor.GOLD), GENERAL_TOOLTIP_BLOCK_ITEM, DELIGHT_GENERAL_PROPS);
    public static final MetalItemObject meteor = BLOCKS.registerMetal("meteor",  metalBuilder(MaterialColor.TERRACOTTA_YELLOW), GENERAL_TOOLTIP_BLOCK_ITEM, DELIGHT_GENERAL_PROPS);
